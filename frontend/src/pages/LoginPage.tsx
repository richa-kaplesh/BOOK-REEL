...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 rounded-full blur-3xl pointer-events-none" style={{ backgroundColor: 'rgba(200,133,58,0.08)' }} />
      <div className="absolute bottom-0 right-1/4 w-64 h-64 rounded-full blur-3xl pointer-events-none" style={{ backgroundColor: 'rgba(212,105,74,0.06)' }} />
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-bold" style={{ color: 'var(--text-primary)' }}>Welcome back</h1>
          <p className="mt-1.5 font-medium" style={{ color: 'var(--text-muted)' }}>Your reading reels are waiting</p>
        </div>
